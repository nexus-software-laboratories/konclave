...
separate local conversation binding, which is not implemented yet.
...
`examples/contract-alignment.json` demonstrates namespaced actions and explicit
unlimited semantic limits. It is an editable example rather than a built-in mode.
