...
pub use model::{
    ...
    APPLICATION_PROTOCOL_MINOR, AcknowledgeRequest, AddMember, ApplicationContent,
    ApplicationMessage, ChangeMemberRole, ConversationRole, ConversationState, DeliveryClass,
    DeviceCredentialBinding, DirectedRequest, Invitation, JoinProof, MAX_APPLICATION_MESSAGE_BYTES,
    MAX_CONSUMED_INVITATIONS, MAX_MEMBERS, MAX_MLS_KEY_PACKAGE_BYTES, MAX_PAIRING_CIPHERTEXT_BYTES,
    MAX_PAIRING_RELAY_ENDPOINT_BYTES, MAX_PAIRING_WELCOME_BYTES, MAX_PROTOBUF_TOP_LEVEL_FIELDS,
