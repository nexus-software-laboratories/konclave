...
import {
  ...
  collaborationPolicyProposalMessage,
  collaborationPolicyResponseMessage,
...
const cases: ReadonlyArray<{
  ...
  {
    decode: decodeApplicationMessage,
    expected: collaborationPolicyProposalMessage(fixture('collaboration-policy-bundle.bin')),
    name: 'collaboration-policy-proposal-message.bin',
    roundTrip: (bytes) => encodeApplicationMessage(decodeApplicationMessage(bytes)),
  },
  {
    decode: decodeApplicationMessage,
    expected: collaborationPolicyResponseMessage(),
    name: 'collaboration-policy-response-message.bin',
    roundTrip: (bytes) => encodeApplicationMessage(decodeApplicationMessage(bytes)),
  },
  {
    decode: decodeApplicationMessage,
    expected: collaborationPolicyRevocationMessage(),
    name: 'collaboration-policy-revocation-message.bin',
    roundTrip: (bytes) => encodeApplicationMessage(decodeApplicationMessage(bytes)),
  },
  {
