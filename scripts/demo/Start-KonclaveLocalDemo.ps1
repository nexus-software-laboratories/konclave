...
$clientSupportRoot = Join-Path $clientRoot 'share' 'konclave' 'client'
$extensionSource = Join-Path $pluginRoot 'com.github.copilot' 'extensions' `
    'konclave' 'extension.mjs'
$clientSource = Join-Path $clientSupportRoot 'client.mjs'
$genericSource = Join-Path $clientSupportRoot 'generic.mjs'
$genericSkillSource = Join-Path $clientSupportRoot 'skills' 'konclave-generic' 'SKILL.md'
